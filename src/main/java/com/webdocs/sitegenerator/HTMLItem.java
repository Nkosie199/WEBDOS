...
public class HTMLItem {
    ...
    public String thumbnail(String thumbnailPath, String name, String href) {
        clearBuilder();
    ...
    public String materialThumbnail(String thumbnailPath, String name, String href) {
        clearBuilder();
    ...
    public String navigationBarItem(String href, String name) {
        clearBuilder();
        builder.append("\n")
                .append("<a href=\"")
                .append(href)
